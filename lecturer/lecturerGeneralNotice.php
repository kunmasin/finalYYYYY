    ...
    <head>
        ...
        <button class="toggle-button" onclick="toggleSidebar()">
            ...
            <div class="container">
                ...
                <p>The University Management is delighted to inform you that you have been given appointment into , ILORIN, KWARA STATE to study a FIRST DEGREE programme in <?Php echo $user['course']?> with the following details:</p>
