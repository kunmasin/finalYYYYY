        ...
        <button class="toggle-button" onclick="toggleSidebar()">
            ...
            <div class="content">
                        ...
                        <?php 
                            ...
                            $result= $mysqli -> query("SELECT  image FROM lecturer_users WHERE id = {$user['id']}") or die($mysqli -> error); //NOTE: to get particular user's image
                            if ($data = $result ->fetch_assoc()){
                            echo "<img src='{$data['image']}' width='180px' height='100px'/>";
                            }?>
                         <h2><?php echo $user['lecturer_name'] ?></h2>
                         <p>Lecturer</p>
                         <span><i class="fa fa-circle text-success"></i> Online Status</span>
                         <h2>Welcome To the STUDENT DISCIPLINARY PORTAL</h2>
                         <p>we are here to make life more convenient and easy for you.</p>
                         </div>
                        ...
                        <tr>
                            <td>
                                <strong>Psosition:</strong> <?php echo  $user['office'] ?>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <strong>Home Address:</strong> <?php echo $user['address']?>
                            </td>
                            <td>
