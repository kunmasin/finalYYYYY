...
$sql = "SELECT id, names, email, matric_no, gender, lvl_admitted, course FROM student_users";
$result = $conn->query($sql);
?>
<!DOCTYPE html> 
<php>
    <head>
        ...
        <button class="toggle-button" onclick="toggleSidebar()">
            ...
            <h1 class="text-dark page-header">LIST STUDENTS</h1>
    ...
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        ...
        echo "<td>" ."Skilled Hands Wise Minds". "</td>";
      }
    } else {
