        ...
        <button class="toggle-button" onclick="toggleSidebar()">
            ...
            <div class="content">
                        ...
                        <?php 
                            ...
                            $result= $mysqli -> query("SELECT  image FROM admin_users WHERE sN = {$user['sN']}") or die($mysqli -> error); //NOTE: to get particular user's image
                            if ($data = $result ->fetch_assoc()){
                                echo "<img src='{$data['image']}' width='180px' height='100px'/>";
                            }?>
                         <h2><?php echo $user['usernames'] ?></h2>
                         <p>Administrator</p>
                        ...
                        <tr>
                            <td>
                                <strong>Position:</strong> <?php echo  $user['position'] ?>
                            </td>
                            <td>
